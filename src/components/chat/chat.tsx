        ...
        <div className="chat-wrapper">
            {
                ...
                <div className="chat">
                    ...
                    <div className="chat__body">
                        ...
                        <div className="chat__message chat__message_mine">
                            <p className="chat__message-text">
                            #934434 до сих пор не пришло зачисление
                            </p>
                            <span className="chat__message-time">14:47</span>
                        </div>
                    </div>
                    <form className="chat__footer">
                        <input type="text" className="chat__input" placeholder="Ваше сообщение..."/>
                        <button className="chat__sender">
