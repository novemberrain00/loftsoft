...
const SuccessPaymentPage: FC<SuccessPaymentPagePropsI> = () => {
    const { id, order_data, total_price } = useSelector((state: RootState) => state.purchase.purchase as PurchaseI);
                ...
                <div className="container success__container">
                    ...
                    <div className="block success__products">
                        ...
                        <ul className="list success__products-list">
                            {
                                order_data.map(({id, title, items, give_type }) => {
                                    return (
                                        <li key={id} className="success__products-item">
