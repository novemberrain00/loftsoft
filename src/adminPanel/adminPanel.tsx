import { FC, ReactNode, useEffect, useState, MouseEvent, ReactElement } from "react";
...
const AdminPanel: FC<AdminPanelPropsI> = ({children}) => {
    ...
    const renderAdminPanel = () : ReactElement | null => {
        const layout = (
            <>
        ...
        if(!userData.id && !window.localStorage.getItem('access_token')) {
            return <NotFoundPage/>;
        }
